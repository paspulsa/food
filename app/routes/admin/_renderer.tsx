  ...
  return (
    <html lang="id" class="dark">
      <head>
        ...
        {/* 1. PENAMBAHAN TEMA RUBY RED DI SINI */}
        <style dangerouslySetInnerHTML={{
          __html: `
            ...
            .theme-ruby { --color-primary: 224 17 95; } /* Ruby Red (Merah Menyala) */
        ...
        <div class="flex h-screen overflow-hidden relative">
          ...
          <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-darkpanel border-r border-gray-200 dark:border-darkborder flex flex-col transform -translate-x-full transition-transform duration-300 ease-in-out md:relative md:translate-x-0 peer-checked:translate-x-0">
            ...
            <nav id="admin-nav" class="flex-1 p-4 space-y-1.5 overflow-y-auto">
              ...
              <a href="/admin/promos" class="nav-link flex items-center justify-between px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary dark:hover:text-primary transition-all font-medium text-sm">
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                  Banner Promo
                </div>
              </a>
              <a href="/admin/members" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary dark:hover:text-primary transition-all font-medium text-sm">
              ...
              <a href="/admin/coupons" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary dark:hover:text-primary transition-all font-medium text-sm">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path></svg>
                Kupon & Voucher
              </a>
              <a href="/admin/delivery" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary dark:hover:text-primary transition-all font-medium text-sm">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                Jarak & Ongkir
              </a>
              <a href="/admin/gopay" class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary dark:hover:text-primary transition-all font-medium text-sm">
          ...
          <div class="flex-1 flex flex-col min-w-0 bg-gray-100 dark:bg-[#0B1120]">
            <header class="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-darkborder bg-white dark:bg-darkpanel z-10">
              ...
              <div class="flex items-center gap-4">
                {/* 2. PENAMBAHAN OPSI DROPDOWN RUBY RED DI SINI */}
                <select id="theme-color-select" class="bg-gray-50 dark:bg-darkbg text-xs border border-gray-200 dark:border-darkborder rounded-lg px-2 py-1.5 outline-none cursor-pointer dark:text-white font-medium">
                  ...
                  <option value="theme-ruby">Ruby Red (New)</option>
                </select>
          ...
          __html: `
            document.addEventListener('DOMContentLoaded', () => {
              ...
              colorSelect.addEventListener('change', (e) => {
                ...
                // 3. PENAMBAHAN CLASS PENGHAPUS 'theme-ruby' AGAR BISA DIGANTI-GANTI
