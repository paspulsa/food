...
                </div>
              </a>
              <a href="/admin/promo" class="nav-link flex items-center justify-between px-3 py-2.5 rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-primary dark:hover:text-primary transition-all font-medium text-sm">
                <div class="flex items-center gap-3">
