    ...
    <div class="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside class="w-64 bg-slate-900 text-slate-200 flex flex-col shadow-xl">
        ...
        <div class="p-4 border-t border-slate-800 bg-slate-950">
          <a href="/auth/logout" class="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-lg font-bold text-sm bg-red-600 hover:bg-red-700 text-white transition-colors shadow-md">
