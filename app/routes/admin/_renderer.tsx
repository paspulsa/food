...
                <button class="w-full bg-darkpanel dark:bg-gray-800 text-white font-medium py-2 rounded-lg text-sm mb-2 hover:bg-gray-700 transition-colors shadow-sm">Chat Me</button>
                <p class="text-xs text-gray-500 dark:text-gray-400">Have a problem? <strong class="text-gray-700 dark:text-gray-300">DON'T WORRY</strong> please contact us.</p>
              </div>
