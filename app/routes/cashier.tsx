  ...
  return c.render(
    <div class="space-y-6 pb-10 max-w-7xl mx-auto px-4 mt-6">
      ...
      <div class="flex items-center justify-between bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <div>
          <h2 class="text-2xl font-bold text-gray-800">💰 Layar Kasir</h2>
          <p class="text-gray-500 text-sm mt-1">Verifikasi uang tunai agar pesanan masuk ke dapur.</p>
        </div>
        <div class="bg-orange-50 text-orange-600 px-4 py-2 rounded-xl font-bold border border-orange-200">
          ...
          <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
             <div>
               <div class="flex justify-between items-start mb-3">
                 ...
                 <span class="text-[10px] font-black uppercase px-2 py-1 rounded bg-blue-50 text-blue-600">{o.order_type}</span>
               </div>
               <h3 class="text-lg font-black text-gray-800 leading-tight">{o.customer_name}</h3>
               <p class="text-sm font-bold text-gray-500 mt-1">{o.table_id !== 'TAKEAWAY' ? `Meja: ${o.table_id}` : 'Takeaway'}</p>
